...
class Simulator:
    ...
    def __init__(
        ...
        # NOTE: fork of Luna's Sprint 3.2 simulator.py with path fix for
        # current repo layout (Sprint_2/Sprint_2b, Sprint_3/). Original untouched.
        here = Path(__file__).resolve().parent              # .../daniel_validation/
        sprint3 = here.parent.parent                        # Sprint_3/
        sprint3_1 = sprint3 / "Sprint 3.1"                  # Sprint_3/Sprint 3.1/
        sprint2b = sprint3.parent / "Sprint_2" / "Sprint_2b"

        self._baseline_path = Path(baseline_path) if baseline_path else sprint3_1 / "Sprint3_Baseline_State.csv"
        self._model_path = Path(model_path) if model_path else sprint2b / "Sprint2b_XGBoost_v3.pkl"
